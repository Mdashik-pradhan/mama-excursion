    ...
    return (
        <div>
            <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
                <Container>
                <Navbar.Brand href="#home">Mama excursion</Navbar.Brand>
                ...
                <Nav className="ml-auto">
                    ...
                    
                    {
                        ...
                        <div className="md:flex justify-center items-center">
                            ...
                            <button onClick={logout} className="rounded hover:bg-green-500 md:block hidden  transition duration-300 ease-in-out text-white font-semibold border-2 border-green-500 px-2 ml-2"><i className="fas fa-sign-out-alt"></i> Log Out</button>
                        </div>
                        :<Link className="no-underline text-white px-2 bg-green-500 text-lg rounded" to="/login"><i class="fas fa-sign-in-alt"></i> Login</Link>
                    }
                </Nav>
                </Navbar.Collapse>
                </Container>
